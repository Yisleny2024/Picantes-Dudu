                ...
                <div class="col-lg-12">
					...
					<div class="col-md-12">	
						<div class="col-md-6">	
							...
							<div class="form-group">
							  <label for="ProductName">Marca del Producto:</label>
							  <input type="text" name="ProductName" class="form-control" id="ProductName" placeholder="Ingresa la cantidad del producto" required>
							</div>	
						...
						<div class="col-md-6">	
							<div class="form-group">
							  <label for="ProductSize">Peso:</label>
							  <input type="text" name="ProductSize" class="form-control" id="ProductSize" placeholder="Peso" required>
							</div>
						
							<div class="form-group">
							  <label for="ProductColor">Sabores Disponibles:</label>
							  <input type="text" name="ProductColor" class="form-control" id="ProductColor" placeholder="Ingrese el sabor de su producto" required>
							</div>
							
							<div class="form-group">
							  <label for="ProductCategory">Categoria:</label>
							  <input type="text" name="ProductCategory" class="form-control" id="ProductCategory" placeholder="Ingrese el nivel del P" required>
							</div>
