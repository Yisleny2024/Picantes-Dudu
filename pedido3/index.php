                    ...
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img class="img-responsive img-full" src="img/slide-1.png.jpeg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/slide-2.png.jpeg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/slide-3.png.jpeg" alt="">
                            </div>
							<div class="item">
                                <img class="img-responsive img-full" src="img/slide-4.png.jpeg" alt="">
                            </div>
                        </div>
		...
		<div class="col-sm-4 col-lg-4 col-md-4">
             <div class="thumbnail">
                ...
                <div class="caption">
					...
					<p><strong>Peso:</strong> '.$Rows[3].'</p>
					<p><strong>Sabores Disponibles:</strong> '.$Rows[4].'</p>
